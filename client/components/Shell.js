...
export default function Shell({ user, children }) {
  ...
  return (
    <div className="min-h-screen lg:flex">
      <RouteTransition />
      <aside className="purple-grid sidebar-shell bg-ink flex flex-col p-5 text-white shadow-[18px_0_70px_rgba(24,3,40,.12)] lg:fixed lg:inset-y-0 lg:h-screen lg:w-72">
        <div className="sidebar-brand mb-8 flex shrink-0 items-center gap-3"><div className="grid h-11 w-11 place-items-center rounded-2xl bg-gradient-to-br from-fuchsia-400 to-violet-600 font-black shadow-lg shadow-purple-950">I&C</div><div><div className="font-bold">Irshad & Company</div><div className="text-xs text-violet-200/60">Sales command system</div></div></div>
